...
(
  ...
  git clone https://github.com/szhai1969/jd-scripts-docker.git /jd-scripts-docker_tmp
...
(
  ...
  git clone --branch=master https://github.com/szhai1969/jd_scripts.git /scripts_tmp
  [ -d /scripts_tmp ] && {
    rm -rf /scripts
